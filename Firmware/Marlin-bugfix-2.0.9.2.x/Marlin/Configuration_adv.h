 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN //Shane Assigned to the Hotend
...
//
#define NUM_Z_STEPPER_DRIVERS 2   // (1-4) Z options change based on how many //Shane
...
// LCD Print Progress options
  ...
  #define LONG_FILENAME_HOST_SUPPORT //Shane

  // Enable this option to scroll long filenames in the SD card menu
  #define SCROLL_LONG_FILENAMES //Shane
   ...
   */
  #define SDCARD_CONNECTION ONBOARD //Shane
 ...
 */
#define BABYSTEPPING //Shane
#if ENABLED(BABYSTEPPING)
  //#define INTEGRATED_BABYSTEPPING         // EXPERIMENTAL integration of babystepping into the Stepper ISR
  //#define BABYSTEP_WITHOUT_HOMING
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement). //Shane
 ...
 */
   ...
   */
  #define STEALTHCHOP_XY //Shane
  #define STEALTHCHOP_Z
  #define STEALTHCHOP_I
  #define STEALTHCHOP_J
  #define STEALTHCHOP_K
  #define STEALTHCHOP_E //Shane Might make extruder perform better
   ...
   */
  //#define SENSORLESS_HOMING // StallGuard capable drivers only //Shane maybe
